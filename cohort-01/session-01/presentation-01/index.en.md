...
Assignment participation is optional. Use the fixed four-part Markdown template — What I Built, Design Decisions, Troubleshooting, Screenshots — in the [Cohort 1 assignment repository](https://github.com/AWS-Student-Builder-Group-at-UOS/cohort-01-assignments), and submit **one PR per person per session**. The core team leads reviews, and general members can also comment and review. You reply or revise within the same PR. After Subin Son (`ssub17`) gives final approval, the core team merges the submission to preserve the learning record.
